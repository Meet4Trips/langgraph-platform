...
def create_research_agent(llm: ChatOpenAI) -> Any:
...
def create_restaurant_finder(llm: ChatOpenAI) -> Any:
...
def create_logistics_agent(llm: ChatOpenAI) -> Any:
...
def create_poi_agent(llm: ChatOpenAI) -> Any:
